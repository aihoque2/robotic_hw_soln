...
class Sensor(Thread):  
    ...
    def connect(self) -> bool:
        # Wait for a connection
            print('waiting for a connection for' , self.name)
...
def main(args=None):
    ...
    sensor1 = Sensor('127.0.0.3', 10000, 2000, 0.001, "sensor1") # Define a sensor with 2000Hz sampling rate and 1ms delay
    t1 = Thread(target = sensor1.run)
    t1.daemon = True

    ## you can also launch a second sensor
    sensor2 = Sensor('127.0.0.3', 10001, 4000, 0.003, "sensor2") # Define a sensor with 4000Hz sampling rate and 3ms delay
